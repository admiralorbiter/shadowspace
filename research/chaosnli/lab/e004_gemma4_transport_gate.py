"""E004 Gemma 4 12B 20-Item Transport Gate Harness.

Runs 20 items x 6 permutations = 120 unique requests for gemma4:12b under the exact frozen E004 /v1/chat/completions protocol:
  - temperature = 1.0
  - max_tokens = 1
  - logprobs = True
  - top_logprobs = 20
...
def main():
    ...
    out_responses_file = out_dir / "gate120_gemma4-12b_v2_abc_t10_lpe.jsonl"
    ...
    gate_out_path = PROJECT_ROOT / "research" / "chaosnli" / "results" / "E004_gemma4_transport_gate_summary.json"
