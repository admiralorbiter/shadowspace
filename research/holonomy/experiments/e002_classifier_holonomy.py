...
def run_e002_classifier_holonomy_experiment(
    ...
    # Estimate cross-orbit edge transport connections (Ta, Tb, Ta_inv, Tb_inv)
    ...
    path_transport = PathTransport([t_a, t_b, t_a_inv, t_b_inv])
    ...
    result = ModelAuditResult(
        ...
        artificial_curvature_detected=bool(not hol_res.affine_is_flat),
    )
