...
4. [Testing and Validation](PROJECT_DECISIONS.md) — test layers, fixtures, invariant tests, manual scripts (176 tests passing, 87.3% coverage)
...
7. [Project Decisions](MATHEMATICAL_AND_RESEARCH_KNOWLEDGE_BASE.md) — ADR-001 through ADR-016
